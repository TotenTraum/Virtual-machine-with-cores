...
namespace VirtualProcessor
{
    class Translator
    {
        ...
        protected static CommandMap getMapOfCommand()
        {
            ...
            map1.Add("load", new loadMemory());
            map1.Add("out", new Output());
            ...
            map1.Add("sleep", new SLEEP());
            map1.Add("begincritical", new BegCritSection());
            map1.Add("endcritical", new EndCritSection());
            return map1;
        }
